...
export const ContractDetails: React.FC<ContractDetailsProps> = ({
    ...
    const handleAddReminderTemplate = () => {
        ...
        const hasExistingTemplate =
            contractForm.notes &&
            contractForm.notes.includes("<b>Reminder Name:</b>");

        let updatedNotes;
        if (hasExistingTemplate) {
            const templatePattern =
                /<b>Reminder Name:<\/b>[\s\S]*?<b>Non-Renew Sent Date:<\/b>[^<]*<br>/;
            updatedNotes = contractForm.notes.replace(templatePattern, generatedNote);
        } else {
            updatedNotes = contractForm.notes
        ...
        if (richText.current) {
            richText.current.setContentHTML(updatedNotes);
        }
    };
                        ...
                        <View style={styles.row}>
                            <View style={styles.inputGroup}>
                                <FormField
                                    ...
                                    placeholder="website or email address"
                                />
                            </View>
                            <View style={styles.inputGroup}>
                                <FormField
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.richEditorContainer}>
                            ...
                            <RichTextEditor
                                ref={richText}
                                initialContentHTML={contractForm.notes}
                                onChange={(text) => onContractChange("notes", text)}
                                placeholder=""
