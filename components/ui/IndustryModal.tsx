...
import { flattenIndustries, getSortedIndustries, searchIndustries, useIndustries } from "@/api/settings/useGetIndustries";
// import {
//     flattenIndustries,
//     getSortedIndustries,
//     searchIndustries,
//     useIndustries
// } from "@/api/settings/useReminders";
    ...
    useEffect(() => {
        if (allIndustries?.length > 0) {
            if (searchQuery.trim()) {
                ...
                const names = getSortedIndustries(searched);
                setFilteredIndustries(names);
            } else {
                // Show all sorted industries
                const names = getSortedIndustries(allIndustries);
                setFilteredIndustries(names);
            }
        }
        ...
        <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
            <View style={styles.bottomSheetOverlay}>
                ...
                >
                    ...
                    {/* Empty State */}
                    {!isLoading && !error && filteredIndustries?.length === 0 && allIndustries?.length === 0 && (
